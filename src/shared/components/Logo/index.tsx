...
export default function Logo() {
  return (
    <Link
      href="/"
      className="bg-primary-accent-light flex size-10 items-center justify-center rounded-[8px] text-3xl font-bold select-none md:text-4xl"
    >
      <svg
