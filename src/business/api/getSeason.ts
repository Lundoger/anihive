...
import { DEFAULT_LIMITS, CACHE_CONFIG } from "@/shared/constants/api";
...
export async function getSeasons(
	{ page, endpoint, SearchParams }: ISeasonsParams = { page: 1, endpoint: "/seasons/now", SearchParams: { limit: DEFAULT_LIMITS.UPCOMING } }
