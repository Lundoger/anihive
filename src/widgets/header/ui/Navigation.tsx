            ...
            <NavigationMenuItem key={item.title}>
              <NavigationMenuLink
                className={cn(
                  ...
                  "hover:text-primary hover:bg-transparent hover:before:scale-x-100",
                  "focus:text-primary focus:outline-hidden focus:before:scale-x-100",
                  "disabled:pointer-events-none disabled:opacity-50",
                  "data-active:text-primary data-active:hover:bg-primary data-active:before:scale-x-100 data-active:hover:text-white data-[state=open]:before:scale-x-100",
                )}
                asChild
                active={isActive}
              >
